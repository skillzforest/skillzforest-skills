...
```
node scripts/fill_master.js --skill av-schema-logique --master .agents/skills/av-schema-logique/masters/architecture-logique.json --data .agents/skills/av-schema-logique/input.json --name v1 --out .agents/skills/av-schema-logique/out
```
