...
```
node scripts/fill_master.js --skill av-parcours-miro --master .agents/skills/av-parcours-miro/masters/"User story mapping - Template.jpg" --name v1 --out .agents/skills/av-parcours-miro/out
```
