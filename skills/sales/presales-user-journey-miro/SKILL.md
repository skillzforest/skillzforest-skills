...
En extraire : **personas**, **boucle de valeur** (backbone), et les **user stories** classées Must / Nice / Extra. Si ces éléments manquent, les demander à l'utilisateur ou proposer de lancer `presales-functional-scoping` d'abord. **Ne rien inventer** : une story absente reste `[à compléter]`.
