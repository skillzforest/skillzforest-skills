...
```
node scripts/fill_master.js --skill presales-user-journey-miro --master skills/sales/presales-user-journey-miro/masters/"User story mapping - Template.jpg" --name v1 --out skills/sales/presales-user-journey-miro/out
```
