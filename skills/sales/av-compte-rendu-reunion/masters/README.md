...
Commande :
```
node scripts/fill_master.js --skill av-compte-rendu-reunion --master skills/sales/av-compte-rendu-reunion/masters/Compte_rendu_reunion_template_MASTER.docx --data skills/sales/av-compte-rendu-reunion/input.json --name v1 --out skills/sales/av-compte-rendu-reunion/out
```
