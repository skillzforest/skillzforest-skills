...
Exemple de commande :
```
node scripts/fill_master.js --skill av-presentation-client --master skills/sales/av-presentation-client/masters/Presentation_MASTER.pptx --data skills/sales/av-presentation-client/input.json --name v1 --out skills/sales/av-presentation-client/out
```
