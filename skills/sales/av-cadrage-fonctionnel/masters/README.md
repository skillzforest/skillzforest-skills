...
```
node scripts/fill_master.js --skill av-cadrage-fonctionnel --master skills/sales/av-cadrage-fonctionnel/masters/Cadrage_fonctionnel_template_MASTER.docx --data skills/sales/av-cadrage-fonctionnel/input.json --name v1 --out skills/sales/av-cadrage-fonctionnel/out
```
