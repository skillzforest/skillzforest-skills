...
```
node scripts/fill_master.js --skill presales-functional-scoping --master skills/sales/presales-functional-scoping/masters/Cadrage_fonctionnel_template_MASTER.docx --data skills/sales/presales-functional-scoping/input.json --name v1 --out skills/sales/presales-functional-scoping/out
```
