...
```
node scripts/fill_master.js --skill av-cadrage-fonctionnel --master skills/av/av-cadrage-fonctionnel/masters/Cadrage_fonctionnel_template_MASTER.docx --data skills/av/av-cadrage-fonctionnel/input.json --name v1 --out skills/av/av-cadrage-fonctionnel/out
```
