...
Commande de test :
```
node scripts/fill_master.js --skill av-cadrage-plateforme --master skills/av/av-cadrage-plateforme/masters/Cadrage_plateforme_template_MASTER.docx --data skills/av/av-cadrage-plateforme/input.json --name v1 --out skills/av/av-cadrage-plateforme/out
```
