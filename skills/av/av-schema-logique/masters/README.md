...
```
node scripts/fill_master.js --skill av-schema-logique --master skills/av/av-schema-logique/masters/architecture-logique.json --data skills/av/av-schema-logique/input.json --name v1 --out skills/av/av-schema-logique/out
```
