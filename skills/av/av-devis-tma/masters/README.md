...
Commande :
```
node scripts/fill_master.js --skill av-devis-tma --master skills/av/av-devis-tma/masters/Devis_Modulaire_TMA_MASTER.xlsx --data skills/av/av-devis-tma/input.json --name v1 --out skills/av/av-devis-tma/out
```
