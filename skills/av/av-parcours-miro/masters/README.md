...
```
node scripts/fill_master.js --skill av-parcours-miro --master skills/av/av-parcours-miro/masters/"User story mapping - Template.jpg" --name v1 --out skills/av/av-parcours-miro/out
```
