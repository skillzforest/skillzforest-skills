...
- un nouveau projet est créé via `presales-init-project`, ou
...
- `presales-user-journey-miro` prend le cadrage fonctionnel comme matière première
- `presales-client-presentation` s’appuie sur le cadrage fonctionnel pour la vision, le périmètre, les personas, le MVP et le parcours
- `presales-quote` utilise les hypothèses de périmètre et la charge fonctionnelle pour estimer les jours
- `presales-maintenance-quote` s’appuie aussi sur le cadrage fonctionnel pour la volumétrie et la maintenance
