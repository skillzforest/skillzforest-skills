...
- `presales-logical-diagram`
- `presales-physical-diagram`
...
- `presales-quote` s’appuie sur les coûts serveurs, services tiers, licences et charges de développement
- `presales-maintenance-quote` s’appuie sur l’exploitation, la criticité et la complexité de la plateforme
- `presales-client-presentation` utilise la plateforme pour les sections architecture, budget et risques
...
- documenter les réunions de validation via `presales-meeting-notes`
